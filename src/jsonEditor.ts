...
export class JsonEditorProvider implements vscode.CustomTextEditorProvider {
	...
	public static register(context: vscode.ExtensionContext): vscode.Disposable {
		...
		const providerRegistration = vscode.window.registerCustomEditorProvider(JsonEditorProvider.viewType, provider, { supportsMultipleEditorsPerDocument: true });
		//webviewOptions:{enableScripts:true} 
		return providerRegistration;
	}

	private static readonly viewType = 'vscode-json-editor.json';
	...
	private getHtmlForWebview(webview: vscode.Webview): string {
		...
		const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(
			this.context.extensionUri, 'src','editorWebViewScript.js'));
			const jsonEditorUri = webview.asWebviewUri(vscode.Uri.joinPath(
				this.context.extensionUri, 'node_modules', '@json-editor','json-editor', 'dist','jsoneditor.js'));
